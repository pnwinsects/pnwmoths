...
| [0027](0027-no-link-check-cache.md) | The link check keeps no result cache; internal links are `file://` and the CDN images are excluded, so it only ever covered 35 URLs | Accepted |
