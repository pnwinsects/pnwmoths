...
| 260627-oe1 | Static target-range map on the home page (`pnwm-range-map`) — reuses the shared `PNW_REGION_RING` boundary; non-interactive Leaflet figure floated right | 2026-06-27 | complete ✓ |
