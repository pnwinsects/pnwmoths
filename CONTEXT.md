...
- **SpeciesRecord** (occurrence) — one observation: latitude/longitude, state/province, county/district, locality, elevation, date, collector, collection, record type, notes. ~86k–100k records, in two files with different owners (below).
